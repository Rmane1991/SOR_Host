<%@ Page Title="" Language="C#" MasterPageFile="~/PayRakamSBM.Master" AutoEventWireup="true" CodeBehind="AgPreVerification.aspx.cs" Inherits="PayRakamSBM.Pages.Agent.AgPreVerification" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function SetactiveTab() {
            debugger;
            var tabName = $("[id*=TabName]").val() != "" ? $("[id*=TabName]").val() : "Manual";
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHMasterMain" runat="server">
    ...
    <asp:UpdatePanel ID="upContentBody" runat="server">
        <ContentTemplate>
            ...
            <asp:TextBox ID="Tabva" runat="server" Visible="false" />
            <div class="container-fluid">
                <div class="breadHeader">
                    <h5 class="page-title">Agent Pre Verification</h5>
                </div>
                <!-- Filter Accordion -->
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div class="row d-flex justify-content-center align-items-center">
                                            ...
                                            <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap searchbox-btns">
                                                ...
                                                <button type="button" id="btnClear" runat="server" class="themeBtn resetBtn themeCancelBtn me-0" data-bs-toggle="modal" onserverclick="btnClear_Click">
                                                    Reset
                                                </button>
                                            </div>
                        ...
                        <div id="Bulk" class="tab-pane fade">
                            <asp:Panel ID="Panel2" runat="server" Width="100%" Style="overflow: hidden; margin: 0px 0px;">
                                ...
                                <asp:Panel ID="panel1" runat="server" HorizontalScroll="false" ScrollBars="None" Style="padding: 5px 10px 0px 0px;">
                                    <div class="form-group row">
                                        <div class="tableBorderBox HeaderStyle" style="width: 100%; padding: 10px 10px; overflow: scroll; max-height: 400px;">
                                            <asp:GridView ID="gvAgPreBulk" runat="server"
                                                ...
                                                OnRowCommand="gvAgPreBulk_RowCommand"
                                                AllowSorting="True"
                                                OnPageIndexChanging="gvAgPreBulk_PageIndexChanging">
                                                <HeaderStyle HorizontalAlign="Center" Wrap="false" />
                                                            ...
                                                            <asp:UpdatePanel ID="UpButtons" runat="server">
                                                                <ContentTemplate>
                                                                    ...
                                                                    <asp:ImageButton ID="btnViewDownloadPre" runat="server" ImageUrl="../../images/4726040.png" Width="20px" Height="20px"
                                                                        CommandName="DownloadDoc" ToolTip="Download Reg. Document" CommandArgument='<%# Eval("FileID") %>' />
                                                                    &nbsp;&nbsp;
                                                                    <asp:ImageButton ID="btnViewDownloadZip" runat="server" ImageUrl="../../images/zip-file-format.png" Width="20px" Height="20px"
                                                                        CommandName="DownloadZip" ToolTip="Download ZIP Document" CommandArgument='<%# Eval("FileID") %>' />
                                                                </ContentTemplate>
                                                                <Triggers>
                                                                    <asp:PostBackTrigger ControlID="btnViewDownloadPre" />
                                                                    <asp:PostBackTrigger ControlID="btnViewDownloadZip" />
                                                                </Triggers>
                                                            </asp:UpdatePanel>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                        ...
                                                        <div class="speakers xs-mb30" style="width: 132px; height: 108px;">
                                                            ...
                                                            <div class="spk-img">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <asp:ImageButton ID="btnViewDownload" ImageUrl="../../images/download.png" runat="server" Width="36px" Height="36px" Style="margin-left: -41px; margin-top: 9px;" ToolTip="Download Doc" OnClick="btnViewDownload_Click" />
                                                    ...
                                                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                                        <div class="speakers xs-mb30"  style="width: 132px; height: 108px;">
                                                            <div class="spk-img">
                                                                ...
                                                                <ul>
                                                                    <li>
                                                                         <asp:ImageButton ID="ImageButton2"  ImageUrl="../../images/download.png" runat="server" Width="36px" Height="36px" style="margin-left: -41px; margin-top: 9px;" ToolTip="Download Doc" OnClick="ImageButton1_Click" CommandArgument='<%#Eval("Agentid") %>' />
                                                                        <%--<button type="button" style="font-size: 35px; background-color: transparent; border: none; width: 5px; height: 5px; padding-bottom: 10px;" runat="server" onserverclick="Unnamed_ServerClick"><i style="color: white; width: 5px; height: 5px;" class="fa fa-download"></i></button>--%>
                                                                    </li>
                                                                    <li>
                                                                        ...
                                                                        <%-- <asp:ImageButton ID="EyeImage1" ImageUrl="../../images/eyeview.png" runat="server" Width="36px" Height="36px" ToolTip="View Doc" Style="margin-left: -43px; margin-top: 9px;" OnClientClick="SetValue('AddProof');" />--%>
                                                                   </li>
                                                                </ul>
                                                            </div>
                                                    ...
                                                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                                        <div class="speakers xs-mb30"  style="width: 132px; height: 108px;">
                                                            <div class="spk-img">
                                                                ...
                                                                <ul>
                                                                    <li>
                                                                         <asp:ImageButton ID="ImageButton4"  ImageUrl="../../images/download.png" runat="server" Width="36px" Height="36px" style="margin-left: -41px; margin-top: 9px;" ToolTip="Download Doc" OnClick="imgbtnform_Click" CommandArgument='<%#Eval("Agentid") %>' />
                                                                        <%--<button type="button" style="font-size: 35px; background-color: transparent; border: none; width: 5px; height: 5px; padding-bottom: 10px;" runat="server" onserverclick="Unnamed_ServerClick"><i style="color: white; width: 5px; height: 5px;" class="fa fa-download"></i></button>--%>
                                                                        <%--  <a href="#"><i class="fa fa-download"></i></a>--%>
                                                                    </li>
                                                                    <li>
                                                                       ...
                                                                       <%-- <asp:ImageButton ID="EyeImage3" ImageUrl="../../images/eyeview.png" runat="server" Width="36px" Height="36px" ToolTip="View Doc" Style="margin-left: -43px; margin-top: 9px;" OnClientClick="SetValue('SigProof');" />--%>
                                ...
                                <div class="panel-body" style="margin-top: 50px; padding-top: 70px;">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-xm-12">
                                                <label class="selectInputLabel" for="exampleInputEmail1">Remarks: <span class="err">*</span></label>
                                                </br>
                        ...
                        <div>
                            <div class="row">
                                <div class="col-md-3 offset-5 col-xm-12" style="margin-left: 235px">
                                    <asp:Button runat="server" ID="btnSubmitDetails" Style="margin-left: auto" OnClick="btnSubmitDetails_Click" OnClientClick="Confirm();" class="themeBtn themeApplyBtn" Text="Submit" ValidationGroup="Veri"></asp:Button>
                                </div>
                                <div class="col-md-3 col-xm-12">
                                    <button type="button" class="themeBtn themeCancelBtn me-0" onclick="ClearRemark()" validationgroup="Veri">Close</button>
                                </div>
                            </div>
                            <asp:ValidationSummary
                                HeaderText="You must enter or select a value in the following fields:"
                    ...
                    <div class="modal-content" style="width: 500px;">
                        ...
                        <div class="modal-body">
                            ...
                            <button class="themeBtn resetBtn themeCancelBtn me-0" id="bulkClose" runat="server" style="width: 15%" onserverclick="bulkClose_ServerClick">
                                ...
                                <button class="themeBtn resetBtn themeCancelBtn me-0" id="BulkDecline" runat="server" validationgroup="Verif" style="width: 15%" type="button" onserverclick="BulkDecline_ServerClick">Decline</button>
