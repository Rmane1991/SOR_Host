<%@ Page Title="" Language="C#" MasterPageFile="~/SOR.Master" AutoEventWireup="true" CodeBehind="RestrictedName.aspx.cs" Inherits="SOR.Pages.Upload.RestrictedName" %>
    ...
    <asp:UpdatePanel ID="upContentBody" runat="server">
        <ContentTemplate>
            <asp:HiddenField ID="TabName" runat="server" />
                    <div id="Upload" class="tab-pane fade show active" tabindex="0">
                        <asp:Panel ID="pnlAddPages" runat="server" Width="100%" Style="overflow: hidden;">
                            <div class="breadHeader">
                                <h5 class="page-title">Restricted Name</h5>
                            </div>
                            <div class="accordion summary-accordion" id="history-accordion">
                                ...
                                <div class="table-box">
                                    <div class="HeaderStyle gv-responsive">
                                        <asp:GridView ID="gvNegativeAgent" runat="server" CssClass="GridView"
                                            ...
                                            DataKeyNames="FileID"
                                            AllowSorting="True"
                                            OnRowCommand="gvNegativeAgent_RowCommand"
                                            OnPageIndexChanging="gvNegativeAgent_PageIndexChanging"
