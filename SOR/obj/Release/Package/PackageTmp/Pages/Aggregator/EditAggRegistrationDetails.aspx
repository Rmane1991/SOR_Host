<%@ Page Title="" Language="C#" MasterPageFile="~/SOR.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="EditAggRegistrationDetails.aspx.cs" Inherits="SOR.Pages.Aggregator.EditAggRegistrationDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphmastermain" runat="server">
    ...
    <div class="container-fluid">
        <div class="breadHeader">
            <h5 class="page-title">Edit Aggregator Details</h5>
        </div>
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap">
                                                        <div class="col">
                                                            ...
                                                            <asp:TextBox runat="server" CssClass="input-text form-control" Enabled="false" ID="txtFirstName" PlaceHolder="First Name" Width="100%" MaxLength="50"></asp:TextBox>
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <asp:DropDownList runat="server" class="form-control" Enabled="false" CssClass="maximus-select w-100" ID="ddlGender" Width="100%">
                                                         ...
                                                         <div class="col" id="dvfield_PANNo" runat="server" style="display: normal;">
                                                            ...
                                                            <asp:TextBox runat="server" CssClass="input-text form-control" ID="txtPANNo" Enabled="false" PlaceHolder="Enter 10 digit PAN No." Width="100%" MaxLength="10"></asp:TextBox>
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <asp:TextBox runat="server" CssClass="input-text form-control" ID="txtaadharno" Enabled="false" Width="100%" PlaceHolder="Enter 12 digit Aadhaarcard No." MaxLength="12" onkeypress="return isNumber(event)"></asp:TextBox>
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap">
                                                        ...
                                                        <div class="col">
                                                                        ...
                                                                        <!-- input -->
                                                                        <div class="col" style="display:none">
                                                                            <label for="exampleInputEmail1">Country</span></label>
                            ...
                            <div id="collapseSummarythree" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap searchbox-btns">
                                        ...
                                        <asp:Button runat="server" ID="btnCloseReceipt" CssClass="themeBtn resetBtn themeCancelBtn me-0r" OnClick="btnCloseReceipt_Click"  ToolTip="Close" Text="Back" Style="margin-bottom:17px;"></asp:Button>
                                    </div>
