<%@ Page Title="" Language="C#" MasterPageFile="~/SOR.Master" AutoEventWireup="true" CodeBehind="PatchVerification.aspx.cs" Inherits="SOR.Pages.Patch.PatchVerification" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
    /* Hide the first column (id) in GridView */
    #<%= gvVerification.ClientID %> tr td:nth-child(2),
    #<%= gvVerification.ClientID %> th:nth-child(2) {
        display: none;
    }
</style>
        ...
        <ContentTemplate>
            ...
            <div class="container-fluid">
                <div class="breadHeader">
                    <h5 class="page-title">Patch Verification</h5>
                </div>
                <!-- Filter Accordion -->
                            ...
                            <div class="form-group row">
                                <div class="tableBorderBox HeaderStyle" style="width: 100%; padding: 10px 10px; overflow: scroll; max-height: 400px;">
                                    <asp:GridView ID="gvVerification" runat="server"
                                        ...
                                        OnPageIndexChanging="gvVerification_PageIndexChanging"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="reqid" HeaderText="Patch Version" Visible="false" />
                                            <asp:BoundField DataField="patchtype" HeaderText="Patch Type" />
                                            <asp:BoundField DataField="scheduledatetime" HeaderText="Schedule Date-Time" />
                                            <asp:BoundField DataField="verificationstatus" HeaderText="Status" />
                                            <asp:BoundField DataField="createdby" HeaderText="Requested By" />
                                            <asp:BoundField DataField="createdon" HeaderText="Requested On" />
