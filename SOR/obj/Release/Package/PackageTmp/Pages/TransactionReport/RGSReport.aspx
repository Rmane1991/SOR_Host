<%@ Page Title="" Language="C#" MasterPageFile="~/SOR.Master" AutoEventWireup="true" CodeBehind="RGSReport.aspx.cs" Inherits="SOR.Pages.TransactionReport.RGSReport" %>
    ...
    <asp:UpdatePanel ID="upContentBody" runat="server">
        <ContentTemplate>
            <div class="breadHeader">
                <h5 class="page-title">Rule Wise Transactions</h5>
            </div>
                        ...
                        <div class="accordion-body">
                            ...
                            <div>
                                <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap">
                                    ...
                                    <div class="col">
                                        <label class="selectInputLabel" for="selectInputLabel">Group</label>
                                        <asp:DropDownList ID="ddlGroup" runat="server" CssClass="maximus-select w-100" AutoPostBack="true" OnSelectedIndexChanged="ddlGroup_SelectedIndexChanged">
                                            <asp:ListItem Text="All" Value="0"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col">
                                        <label class="selectInputLabel" for="selectInputLabel">Rule</label>
                                        <asp:DropDownList ID="ddlRule" runat="server" CssClass="maximus-select w-100" AutoPostBack="false">
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap searchbox-btns">
                                        ...
                                        <button type="button" id="Button1" runat="server" style="margin-top: -7px" class="themeBtn themeApplyBtn" onserverclick="btnSearch_ServerClick" visible="false">
                                            Search</button>
                                        <button type="button" id="Button2" runat="server" style="margin-top: -7px" onserverclick="btnClear_ServerClick" class="themeBtn resetBtn themeCancelBtn me-0" data-bs-toggle="modal" visible="false">
                                            Clear</button>
            ...
            <asp:Panel runat="server" ID="pnaelGrid" Style="width: 50%; padding: 06px 0px; overflow: auto; margin: 0 auto;">
                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                    <ContentTemplate>
                        <div class="HeaderStyle gv-responsive" style="width: 100%; overflow-x: auto;">
                            <asp:GridView ID="gvRuleWiseTransaction" runat="server"
                                ...
                                AllowSorting="True"
                                PageSize="500"
                                OnSorting="gvRuleWiseTransaction_Sorting"
                                Visible="true"
                                OnPageIndexChanging="gvRuleWiseTransaction_PageIndexChanging"
                                Style="width: 100%; table-layout: auto; max-height: 600px; overflow-y: auto; margin: 0 auto;">
                                <RowStyle ForeColor="Black" Height="22px" BorderStyle="Solid" BorderWidth="1px" BorderColor="Black" Wrap="false" HorizontalAlign="Center"></RowStyle>
                                <HeaderStyle BackColor="#000084" Font-Bold="True" ForeColor="Black" Height="25px" Wrap="false" HorizontalAlign="Center"></HeaderStyle>
