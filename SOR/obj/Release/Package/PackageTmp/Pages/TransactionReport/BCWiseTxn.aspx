<%@ Page Title="" Language="C#" MasterPageFile="~/SOR.Master" AutoEventWireup="true" CodeBehind="BCWiseTxn.aspx.cs" Inherits="SOR.Pages.TransactionReport.BCWiseTxn" %>
    ...
    <asp:UpdatePanel ID="upContentBody" runat="server">
        <ContentTemplate>
            <div class="breadHeader">
                <h5 class="page-title">BC Wise Transactions</h5>
            </div>
                            ...
                            <div>
                                <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap">
                                    ...
                                    <div class="col">
                                        ...
                                        <asp:DropDownList ID="ddlBCCode" runat="server" CssClass="maximus-select w-100">
                ...
                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                    <ContentTemplate>
                        <div class="HeaderStyle gv-responsive" style="width: 100%; overflow-x: auto;">
                            <asp:GridView ID="gvBCWiseTransaction" runat="server"
                                ...
                                AllowSorting="True"
                                PageSize="500"
                                OnSorting="gvBCWiseTransaction_Sorting"
                                Visible="true"
                                OnRowDataBound="gvBCWiseTransaction_RowDataBound"
                                OnPageIndexChanging="gvBCWiseTransaction_PageIndexChanging"
