<%@ Page Title="" Language="C#" MasterPageFile="~/PayRakamSBM.Master" AutoEventWireup="true" CodeBehind="SuccessfulTransactions.aspx.cs" Inherits="PayRakamSBM.Pages.TransactionReport.SuccessfulTransactions" %>
    ...
    <asp:UpdatePanel ID="upContentBody" runat="server">
        <ContentTemplate>
            ...
            <div class="breadHeader">
                <h5 class="page-title">Successful Transactions</h5>
            </div>
                        ...
                        <div class="accordion-body">
                            ...
                            <div>
                                <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap">
                                    ...
                                    <div class="col">
                                        <label class="selectInputLabel" for="selectInputLabel">Channels</label>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="inputBox w-100">
                                            <input type="text" id="txtAgentCode" runat="server" class="input-text form-control" style="width: 100%" placeholder="Agent Code/Terminal ID" maxlength="12" />
                                        </div>
                                    </div>
            ...
            <asp:Panel ID="panelGrid" runat="server" Width="100%" HorizontalScroll="false" ScrollBars="None" Style="margin: 5px 10px 0px 0px; padding-right: 0px; overflow: auto">
                ...
                <asp:GridView ID="gvSuccessfulTranaction" runat="server"
                        ...
                        OnPageIndexChanging="gvSuccessfulTranaction_PageIndexChanging">
