<%@ Page Title="" Language="C#" MasterPageFile="~/SOR.Master" AutoEventWireup="true" CodeBehind="OnBoardAggStatus.aspx.cs" Inherits="SOR.Pages.Aggregator.OnBoardAggStatus" %>
    ...
    <asp:UpdatePanel ID="upContentBody" runat="server">
        <ContentTemplate>
            ...
            <div class="breadHeader">
                <h5 class="page-title">Onboard Aggregator Status</h5>
            ...
            <asp:Panel ID="panelGrid" runat="server" Width="99%" Style="margin: 5px 10px 0px 0px; padding-right: 0px; overflow-x: auto;">
                ...
                <div class="table-box">
                    <div class="tableBorderBox HeaderStyle" style="padding: 10px 10px; overflow: scroll; max-height: 400px;">
                        <asp:GridView ID="gvOnBoardAgg" runat="server"
                            ...
                            Visible="true"
                            BorderColor="White"
                            OnRowCommand="gvOnBoardAgg_RowCommand"
                            OnRowDataBound="gvOnBoardAgg_RowDataBound"
                            ...
                            OnPageIndexChanging="gvOnBoardAgg_PageIndexChanging">
