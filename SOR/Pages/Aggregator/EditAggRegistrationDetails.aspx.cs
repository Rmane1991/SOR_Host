...
{
    public partial class EditAggRegistrationDetails : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (HiddenField1.Value.ToString() == "Yes")
                {
                    ...
                    if (ValidateSetProperties())
                    {
                        ...
                        {
                            if (_BCEntity.BCReqId == Convert.ToString(Page.Request.QueryString["BCReqId"]))
                            {
                                _BCEntity.Flag = 5;
                            }
                            else
        ...
        private bool ValidateSetProperties()
        {
            ...
            try
            {
                ...
                //        return false;
                //    }
                //    else _BCEntity.AadharNo = txtaadharno.Text.ToString();
