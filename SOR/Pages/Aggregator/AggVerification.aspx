<%@ Page Title="" Language="C#" MasterPageFile="~/SOR.Master" AutoEventWireup="true" CodeBehind="AggVerification.aspx.cs" Inherits="SOR.Pages.Aggregator.AggVerification" %>
        ...
        <ContentTemplate>
            <div class="container-fluid">
                <div class="breadHeader">
                    <h5 class="page-title">Aggregator Verification</h5>
                </div>
                <!-- Filter Accordion -->
                        ...
                        <div class="tableBorderBox HeaderStyle" style="width: 100%; padding: 10px 10px; overflow: scroll; max-height: 400px;">
                            <asp:GridView ID="gvBusinessCorrespondents" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:ImageButton ID="btnView" runat="server" ImageUrl="../../images/edit.png" Width="20px" Height="20px"
                                                ToolTip="Click here to verify" OnClick="btnView_Click" CommandArgument='<%#Eval("Aggregator ID")+"="+Eval("Email")+"="+Eval("Mobile No")+"="+Eval("Activity Type")+"="+Eval("Aggregator Code")%>' data-toggle="modal" data-target="#myModal" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="Aggregator ID" HeaderText="Aggregator ID" Visible="false" />
                                    <asp:BoundField DataField="Aggregator Code" HeaderText="Code" />
                                    ...
                                    <asp:BoundField DataField="Verification Status" HeaderText="Verification Status" />
                ...
                <div class="modal-dialog" style="width: 800px; padding-left: 10px; margin-left: 25%; height: 425px">
                    <div class="modal-content" style="width: 800px; padding-left: 9px; height: 481px">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="exampleModalTitle">Aggregator Documents</h4>
                        </div>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap">
                                            ...
                                            <div class="col">
                                                <label class="selectInputLabel" for="exampleInputEmail1">Aggregator Name: </label>
