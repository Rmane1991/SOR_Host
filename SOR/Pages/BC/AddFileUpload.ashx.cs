...
{
    /// <summary>
    /// Summary description for AddFileUpload
    /// </summary>
    public class AddFileUpload : IHttpHandler, IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            context.Session["AddFileName"] = filename;
            context.Session["AddFilePath"] = filepath;
        ...
        private string SaveFileAddprof(HttpPostedFile fileUpload, string id, out string FileName, out string FilePath)
        {
            try
            {
                ...
                FilePath = "OnBoarding Documents\\BCDocuments\\" + id + "\\" + "AddressProof" + "\\" + fileUpload.FileName;
