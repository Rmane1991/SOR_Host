...
{
    /// <summary>
    /// Summary description for SigFileUpload
    /// </summary>
    public class SigFileUpload_ : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (context.Request.Files.Count > 0)
            {
                ...
                for (int i = 0; i < files.Count; i++)
                {
                    ...
                    SaveFileSignproof(file, filedata, out filename, out filepath);
                }
            }
            ...
            context.Session["SigFileName"] = filename;
            context.Session["SigFilePath"] = filepath;
        ...
        private string SaveFileSignproof(HttpPostedFile fileUpload, string id, out string FileName, out string FilePath)
        {
            try
            {
                ...
                string FinalPathLocation = AppDomain.CurrentDomain.BaseDirectory + "OnBoarding Documents\\BCDocuments\\" + id + "\\" + "SignatureProof" + "\\";
                ...
                FilePath = "OnBoarding Documents\\BCDocuments\\" + id + "\\" + "SignatureProof" + "\\" + fileUpload.FileName;
                return FinalPathLocation;
            }
            catch (Exception Ex)
            {
                ErrorLog.CommonTrace("Class : SigFileUpload.ashx \nFunction : SaveFile() \nException Occured\n" + Ex.Message);
