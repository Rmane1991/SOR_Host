<%@ Page Title="" Language="C#" MasterPageFile="~/SOR.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="BCRegistration.aspx.cs" Inherits="SOR.Pages.BC.BCRegistration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphmastermain" runat="server">
    ...
    <div class="container-fluid">
        <div class="breadHeader">
            <h5 class="page-title">BC Registration</h5>
        </div>
                ...
                <div id="divMainDetailsGrid" runat="server">
                    ...
                    <asp:Panel ID="panelGrid" runat="server" HorizontalScroll="false" ScrollBars="None" Style="padding: 5px 10px 0px 0px;">
                                    <div class="form-group row">
                                        <div class="tableBorderBox HeaderStyle" style="padding: 0px 10px 10px;">
