<%@ Page Title="" Language="C#" MasterPageFile="~/SOR.Master" AutoEventWireup="true" CodeBehind="FrmBcStatus.aspx.cs" Inherits="SOR.Pages.BC.FrmBcStatus" %>
            ...
            <div id="DIVFilter" runat="server" visible="true">
                <div class="container-fluid">
                    <div class="breadHeader">
                        <h5 class="page-title">Business Correspondents Management</h5>
                    </div>
                    <!-- Filter Accordion -->
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap">
                                                ...
                                                <div class="col" style="display: none;">
                                                    ...
                                                    <div class="selectInputBox">
                                                        <asp:DropDownList ID="ddlClient" runat="server" CssClass="maximus-select w-100" AutoPostBack="true" OnSelectedIndexChanged="ddlClient_SelectedIndexChanged"></asp:DropDownList>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col" style="display: none;">
                                                    ...
                                                    <div class="selectInputBox">
                                                        <asp:DropDownList ID="ddlFranchise" runat="server" CssClass="maximus-select w-100" AutoPostBack="false"></asp:DropDownList>
                                                    </div>
                                                </div>
                                                <!-- input -->
                                            </div>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="selectInputBox">
                                                        <asp:DropDownList runat="server" ID="ddlExport" CssClass="maximus-select w-100" AutoPostBack="true">
                                                            ...
                                                            <%--   <asp:ListItem Text="ZIP" Value="3"></asp:ListItem>--%>
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>

                                                <button type="button" id="btnExport" runat="server" class="themeBtn themeApplyBtn" data-bs-toggle="modal" onserverclick="btnexport_ServerClick">
                                                    Export</button>
                            ...
                            <div class="table-box">
                                <div class="tableBorderBox HeaderStyle" style="width: 100%; padding: 10px 10px; overflow: scroll; max-height: 400px;">
                                    <asp:GridView ID="gvTransactions" runat="server"
                                        ...
                                        DataKeyNames="BC ID,Overall Status"
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="btnEdit" runat="server" ImageUrl="~/images/Edit-01-512.png" Width="16px" Height="16px"
                                                        ToolTip="Click to Edit Details" OnClick="btnEdit_Click" CommandArgument='<%#Eval("BC ID") %>' data-toggle="modal" data-target="#myModal"/>
                                                    &nbsp;&nbsp;
                                                <asp:ImageButton ID="btnReulpoad" runat="server" ImageUrl="~/images/UploadNew.png" Width="16px" Height="16px"
                                                    ToolTip="Click to reupload documets" OnClick="btnReulpoad_Click" CommandArgument='<%#Eval("BC ID") %>' data-toggle="modal" />&nbsp;&nbsp;
                                                <asp:ImageButton ID="btnView" runat="server" ImageUrl="~/images/View.png" Width="16px" Height="16px"
                                                    ToolTip="Click to view documents" OnClick="btnView_Click" CommandArgument='<%#Eval("BC ID") %>' data-toggle="modal" data-target="#myModal" />&nbsp;&nbsp;
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="TxtRemarks" Style="display: none" ValidationGroup="FranchiseReg" runat="server" CssClass="err" ErrorMessage="Please enter Remarks"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12">
                    ...
                    <div class="modal-dialog modal-top modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="exampleModalTitle">BC Documets </h4>
                            </div>
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <asp:DropDownList runat="server" class="form-control" ID="ddlState" Width="100%" OnSelectedIndexChanged="ddlState_SelectedIndexChanged" CssClass="maximus-select w-100" AutoPostBack="true"></asp:DropDownList>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator14" ControlToValidate="txtDistrict" Style="display: none" ValidationGroup="FranchiseReg" runat="server" CssClass="err" ErrorMessage="Please enter district Name "></asp:RequiredFieldValidator>
                                            ...
                                            <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" ControlToValidate="txtLandlineNo" Style="display: none" ValidationGroup="FranchiseReg" runat="server" CssClass="err" ErrorMessage="Please enter landline no"></asp:RequiredFieldValidator>
                                            ...
                                            <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap searchbox-btns">
                                                <asp:Button runat="server" ID="btnSubmitDetails" ValidationGroup="FranchiseReg" OnClientClick="javascript:return  disableMultipleClick();" OnClick="btnSubmitDetails_Click" CssClass="themeBtn themeApplyBtn" BackColor="#003087" Text="Submit"></asp:Button>
