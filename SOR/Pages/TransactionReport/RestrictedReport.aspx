<%@ Page Title="" Language="C#" MasterPageFile="~/SOR.Master" AutoEventWireup="true" CodeBehind="RestrictedReport.aspx.cs" Inherits="SOR.Pages.TransactionReport.RestrictedReport" %>
    ...
    <asp:UpdatePanel ID="upContentBody" runat="server">
        <ContentTemplate>
            <div class="breadHeader">
                <h5 class="page-title">Restricted Name/PIN</h5>
            </div>
                        ...
                        <div class="accordion-body">
                            ...
                            <div>
                                <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap">
                                    ...
                                    <div class="col">
                                        <label class="selectInputLabel" for="selectInputLabel">PinCode</label>
                                        <div class="inputBox w-100">
                                            <input type="text" id="txtPinCode" runat="server" class="input-text form-control" style="width: 100%" placeholder="PinCode" maxlength="6" />
                                        </div>
                                    </div>
                                    <div class="col">
                                        ...
                                        <asp:DropDownList ID="ddlNamePIN" runat="server" CssClass="maximus-select w-100">
                                            ...
                                            <asp:ListItem Text="PIN" Value="2"></asp:ListItem>
            ...
            <asp:Panel runat="server" ID="pnaelGrid" Style="width: 100%; padding: 06px 0px; overflow: auto; margin: 0 auto;">
                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                    <ContentTemplate>
                        <div class="HeaderStyle gv-responsive" style="width: 100%; overflow-x: auto;">
                            <asp:GridView ID="gvRestrictedDetails" runat="server"
                                ...
                                AllowSorting="True"
                                PageSize="50"
                                OnSorting="gvRestrictedDetails_Sorting"
                                Visible="true"
                                OnRowDataBound="gvRestrictedDetails_RowDataBound"
                                OnPageIndexChanging="gvRestrictedDetails_PageIndexChanging"
