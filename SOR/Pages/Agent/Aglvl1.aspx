<%@ Page Title="" Language="C#" MasterPageFile="~/PayRakamSBM.Master" AutoEventWireup="true" CodeBehind="AgLvl1.aspx.cs" Inherits="PayRakamSBM.Pages.Agent.AgLvl1" %>
        ...
        <ContentTemplate>
            ...
            <div class="container-fluid">
                <div class="breadHeader">
                    <h5 class="page-title">Agent Verification Level One</h5>
                </div>
                <!-- Filter Accordion -->
                    ...
                    <div class="tab-content">
                        ...
                        <div id="Bulk" class="tab-pane fade">
                            ...
                            <asp:Panel ID="panel1" runat="server" HorizontalScroll="false" ScrollBars="None" Style="padding: 5px 10px 0px 0px;">
                                <div class="form-group row">
                                    <div class="tableBorderBox HeaderStyle" style="width: 100%; padding: 10px 10px; overflow: scroll; max-height: 400px;">
                                        <asp:GridView ID="gvAgBulkL1" runat="server"
                                            ...
                                            PagerSettings-FirstPageText="First Page"
                                            PagerSettings-LastPageText="Last Page"
                                            OnRowCommand="gvAgBulkL1_RowCommand"
                                            OnPageIndexChanging="gvAgBulkL1_PageIndexChanging">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="false" />
                                            <RowStyle Wrap="false" />
                                            <Columns>
                                                <asp:TemplateField>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-xm-12">
                                                ...
                                                <asp:TextBox ID="txtFinalRemarks" runat="server" class="form-control" MaxLength="200" Style="resize: none; height: 65px; width: 288px;"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="reqName" runat="server" ControlToValidate="txtFinalRemarks" CssClass="err" Display="None" ErrorMessage="Please enter Remarks" ValidationGroup="Veri"></asp:RequiredFieldValidator>
