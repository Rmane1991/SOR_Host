...
namespace SOR.Pages.Agent
{
    ...
    /// </summary>
    public class Handler6 : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            context.Session["SigAgentFileName"] = filename;
            context.Session["SigAgentFilePath"] = filepath;
        ...
        private string SaveFileSignproof(HttpPostedFile fileUpload, string id, out string FileName, out string FilePath)
        {
            try
            {
                ...
                string FinalPathLocation = AppDomain.CurrentDomain.BaseDirectory + "OnBoarding Documents\\AgentDocuments\\" + id + "\\" + "SignatureProof" + "\\";
                ...
                FilePath = "OnBoarding Documents\\AgentDocuments\\" + id + "\\" + "SignatureProof" + "\\" + fileUpload.FileName;
