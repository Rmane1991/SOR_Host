<%@ Page Title="" Language="C#" MasterPageFile="~/SOR.Master" AutoEventWireup="true" EnableViewState="true" CodeBehind="ReprocessRegDetails.aspx.cs" Inherits="SOR.Pages.Agent.ReprocessRegDetails" %>
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap">
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtMiddleName" Style="display: none" ValidationGroup="FranchiseReg" runat="server" CssClass="err" ErrorMessage="Please enter Middle name"></asp:RequiredFieldValidator>--%>
                                                    ...
                                                    <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap">
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ControlToValidate="txtaadharno" Style="display: none" ValidationGroup="FranchiseReg" runat="server" CssClass="err" ErrorMessage="Please enter Aadhaar card no"></asp:RequiredFieldValidator>
                                                    ...
                                                    <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap">
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" ControlToValidate="ddlarea" InitialValue="0" Style="display: none" ValidationGroup="FranchiseReg" runat="server" CssClass="err" ErrorMessage="Population Group."></asp:RequiredFieldValidator>
                                                                 ...
                                                                 <asp:TextBox runat="server" CssClass="input-text form-control" ID="txtagentId" PlaceHolder="Agent Code" Width="100%" MaxLength="10"></asp:TextBox>
                                                                 ...
                                                                 <asp:HiddenField ID="hdAgentId" runat="server" Value="1" />
                                                                 <Ajax:FilteredTextBoxExtender ID="FilteredTextBoxExtender15" runat="server" FilterType="UppercaseLetters,Numbers" TargetControlID="txtagentId" />
                                                                 </div>
                                                    </div>
                                                    <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap">
                                                                    ...
                                                                    <asp:HiddenField ID="HiddenField16" runat="server" Value="1" />
                                                                    <Ajax:FilteredTextBoxExtender ID="FilteredTextBoxExtender19" runat="server" FilterType="UppercaseLetters,Numbers" TargetControlID="txtTerminalId" />
                                                                    </div>
                                                        <div class="col">
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator20" ControlToValidate="txtLongitude" Style="display: none" runat="server" ValidationGroup="FranchiseReg" CssClass="err" ErrorMessage="Please Enter Longitude"></asp:RequiredFieldValidator>
                                                        ...
                                                        <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap">
                                                            ...
                                                            <div class="col">
                                                                        ...
                                                                        <div class="col">
                                                                            ...
                                                                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator19" ControlToValidate="ddlShopDistrict" Width="100%" InitialValue="0" Style="display: none" ValidationGroup="FranchiseReg" runat="server" CssClass="err" ErrorMessage="Please Select Shop District"></asp:RequiredFieldValidator>--%>
                                                                        </div>
                                                                        <br />
                                                                        <div class="col">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseSummarytwo" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                    ...
                                    <div class="row row-cols-auto selectInput-grid20 selectGrid-m-z select-grid-gap">
                                            ...
                                            <div class="col-md-3 col-xm-12"  id="divIdProof" STYLE="display:none;" >
                                                <label for="exampleInputEmail1">File Path. <span class="err">*</span></label>
                                   ...
                                   <div class="row row-cols-auto selectInput-grid20 selectGrid-m-z select-grid-gap">
                                            ...
                                            <div class="col-md-3 col-xm-12" id="divAddressProof" STYLE="display:none;" >
                                      ...
                                      <div class="row row-cols-auto selectInput-grid20 selectGrid-m-z select-grid-gap">
                                            ...
                                            <div class="col-md-3 col-xm-12"  id="divSigProof" style="display:none;">
                                                <label for="exampleInputEmail1">File Path. <span class="err">*</span></label>
                                        ...
                                        <div class="row row-cols-auto selectInput-grid20 selectGrid-m-y select-grid-gap">
                                            ...
                                            <asp:Button runat="server" ID="BtnSubmit" Class="themeBtn themeApplyBtn" ValidationGroup="agentregs" OnClick="BtnSubmit_Click" Text="Submit" OnClientClick="Confirm1();"></asp:Button>
