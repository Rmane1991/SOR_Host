...
{
    /// <summary>
    /// Summary description for Handler21
    /// </summary>
    public class Handler2 : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            context.Session["IdAgentFileName"] = filename;
            context.Session["IdAgentFilePath"] = filepath;
        ...
        private string SaveFile(HttpPostedFile fileUpload, string id, out string FileName, out string FilePath)
        {
            try
            {
                ...
                string FinalPathLocation = AppDomain.CurrentDomain.BaseDirectory + "OnBoarding Documents\\AgentDocuments\\" + id + "\\" + "IdentityProof" + "\\";
                ...
                FilePath = "OnBoarding Documents\\AgentDocuments\\" + id + "\\" + "IdentityProof" + "\\" + fileUpload.FileName;
