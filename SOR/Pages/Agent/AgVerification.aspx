<%@ Page Title="" Language="C#" MasterPageFile="~/SOR.Master" AutoEventWireup="true" CodeBehind="AgVerification.aspx.cs" Inherits="SOR.Pages.Agent.AgVerification" %>
...
.rbl {
    display: block; /* Makes each item appear on its own line */
}

.rbl .rbl-item {
    display: block; /* Forces each list item to take up a full line */
    margin-bottom: 20px;
    margin-right: 20px;
}
        ...
        <ContentTemplate>
            ...
            <div class="container-fluid">
                <div class="breadHeader">
                    <h5 class="page-title">Agent Verification</h5>
                </div>
                <!-- Filter Accordion -->
                    ...
                    <div class="tab-content">
                                        ...
                                        <div class="tableBorderBox HeaderStyle" style="width: 100%; padding: 10px 10px; overflow: scroll; max-height: 400px;">
                                            <asp:GridView ID="gvAgent" runat="server"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:ImageButton ID="btnView" runat="server" ImageUrl="../../images/Edit-01-512.png" Width="20px" Height="20px"
                                                                ToolTip="Click here to verify" OnClick="btnView_Click" CommandArgument='<%#Eval("AgentID")+"="+Eval("Email")+"="+Eval("Mobile No")+"="+Eval("ClientID")+"="+Eval("ActivityType")+"="+Eval("Code")%>' data-toggle="modal" data-target="#myModal" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField Visible="false">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:ImageButton ID="btnViewResp" runat="server" ImageUrl="../../images/eyeview.png" Width="20px" Height="20px"
                                                                ToolTip="Click here to verify" OnClick="btnViewResp_Click" CommandArgument='<%#Eval("AgentID")+"="+Eval("Email")+"="+Eval("Mobile No")%>' data-toggle="modal" data-target="#ModalAgent" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:BoundField DataField="AgentID" HeaderText="Agent ID" />
                                                    <asp:BoundField DataField="Onboarded Status" HeaderText="Onboarded Status" />
                                                    ...
                                                    <asp:BoundField DataField="AadharcardNo" HeaderText="Aadhar No" />
                                                    ...
                                                    <asp:BoundField DataField="Passport No" HeaderText="Passport No" />
                                                    ...
                                                    <asp:BoundField DataField="Business EmailId" HeaderText="EmailId" />
                                                    <asp:BoundField DataField="Mobile No" HeaderText="Mobile No" />
                                                    <%--<asp:BoundField DataField="DocUploadedBy" HeaderText="Doc Uploaded By" />--%>
                        ...
                        <div id="Bulk" class="tab-pane fade">
                            ...
                            <asp:Panel ID="panel1" runat="server" HorizontalScroll="false" ScrollBars="None" Style="padding: 5px 10px 0px 0px;">
                                <div class="form-group row">
                                    <div class="tableBorderBox HeaderStyle" style="width: 100%; padding: 10px 10px; overflow: scroll; max-height: 400px;">
                                        <asp:GridView ID="gvAgBulkL3" runat="server"
                                            AutoGenerateColumns="false"
                                            GridLines="None"
                                            AllowPaging="true"
                                            CssClass="GridView"
                                            ...
                                            PagerSettings-FirstPageText="First Page"
                                            PagerSettings-LastPageText="Last Page"
                                            OnRowCommand="gvAgBulkL3_RowCommand"
                                            OnPageIndexChanging="gvAgBulkL3_PageIndexChanging">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="false" />
                                            <RowStyle Wrap="false" />
                                            <Columns>
                                                    ...
                                                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                                        <div class="speakers xs-mb30" style="width: 132px; height: 108px;">
                                                            ...
                                                            <div class="spk-img">
                                                                ...
                                                                <ul>
                                                                    <li>
                                                                        <asp:ImageButton ID="btnViewDownload" ImageUrl="../../images/download.png" runat="server" Width="36px" Height="36px" Style="margin-left: -41px; margin-top: 9px;" ToolTip="View Doc" OnClick="btnViewDownload_Click" CommandArgument='<%#Eval("Agentid") %>' />
                                                                    ...
                                                                    <li>
                                                                        <%--<asp:ImageButton ID="EyeImage" ImageUrl="../../images/View.png" runat="server" Width="49px" Height="36px" ToolTip="View Doc" Style="margin-left: -43px; margin-top: 9px;" OnClick="EyeImage_Click"/>--%>
                                                            ...
                                                            <div class="spk-img">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <i><img  src="../../images/eyeview.png" style="width:36px; height:36px; margin-left: -47px; margin-top: -31px; font-size:35px;" onclick="SetValue('SigProof');"></i><%--OnClick="EyeImage_Click"--%>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-xm-12" style="margin-bottom: 2%;">
                                                ...
                                                <asp:RadioButtonList ID="rdbtnApproveDecline" CssClass="rbl" runat="server" RepeatLayout="Flow">
