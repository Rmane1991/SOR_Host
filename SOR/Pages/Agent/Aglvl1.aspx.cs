...
{
    public partial class AgLvl1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    bool HasPagePermission = UserPermissions.IsPageAccessibleToUser(Session["Username"].ToString(), Session["UserRoleID"].ToString(), "AgLvl1.aspx", "19");
                ...
                else
                {
                    ...
                    {
                            UserPermissions.RegisterStartupScriptForNavigationList("4", "19", "Manual", "docket-tab");
                            Session["CheckRefresh"] = Server.UrlDecode(System.DateTime.Now.ToString());
                        BindDropdownsBC();
                            BindFileId();
                            FillGrid(EnumCollection.EnumPermissionType.EnableRoles);
                            FillGridBulk(EnumCollection.EnumBindingType.AgBulkL1);
                ...
                else
                {
                    ...
                    {
                        ErrorLog.AgentManagementTrace("AgLvl1: Page_Load: Exception: " + Ex.Message);
                    }
                }
            }
            catch (Exception Ex)
        ...
        private void BindDropdownsBC()
        {
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: BindDropdownsBC: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        ...
        private void BindDropdownsAgent()
        {
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: BindDropdownsAgent: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        ...
        public DataSet FillGrid(EnumCollection.EnumPermissionType _EnumPermissionType)
        {
            ...
            try
            {
                ...
                _AgentRegistrationDAL.Flag = ((int)EnumCollection.EnumPermissionType.PreExport);
                _AgentRegistrationDAL.BCCode = ddlBCCode.SelectedValue != "0" ? ddlBCCode.SelectedValue : null;
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: FillGrid: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
            return ds;
        }
        ...
        public void CommonSave(string fromWhere)
        {
                        ...
                        if ((AgentDataSet != null) && Convert.ToString(ViewState["SelectionType"]) == SelectionType.CheckedAll.ToString())
                        {
                            ...
                            for (int i = 0; i < AgentDataSet.Rows.Count; i++)
                            {
                                try
                                {
                                    ...
                                    _AgentRegistrationDAL.MakerRemark = TxtRemarks.Text.Trim();
                                    _AgentRegistrationDAL.UserName = Session["Username"].ToString();
                            ...
                            foreach (GridViewRow row in gvAgent.Rows)
                            {
                                if (row.RowType == DataControlRowType.DataRow)
                                {
                                    ...
                                    if (chBoxRow.Checked)
                                    {
                                        ...
                                        {
                                            _reocrdsProcessed = _reocrdsProcessed + 1;
                                            SingleSave(_reocrdsProcessed, _Flag, _Flag, row.Cells[3].Text, row.Cells[6].Text, Convert.ToString(Session["Username"]), TxtRemarks.Text.Trim(), row.Cells[32].Text, row.Cells[33].Text, row.Cells[7].Text);
                                            ...
                                            //SingleSave(_reocrdsProcessed, _Flag, _Flag, row.Cells[3].Text, row.Cells[4].Text, Convert.ToString(Session["Username"]), TxtRemarks.Text.Trim(), row.Cells[8].Text, row.Cells[7].Text, row.Cells[5].Text);
                                        }
                                        catch (Exception Ex)
                                        {
                                            _unsuessful = _unsuessful + 1;
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: CommonSave: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        ...
        public void SingleSave(int _reocrdsProcessed, int _StatusFlag, int _Flag, string AgentCode, string _strAgentFullName, string User, string Remarks, string ReceiverEmailID, string ContactNo, string _ClientCode)
        {
            try
            {
                ErrorLog.AgentManagementTrace("AgLvl1: SingleSave: Received - Maker Verification.  StatusFlag: " + _StatusFlag + " Flag: " + _Flag + " AgentCode: " + AgentCode + " Fullname: " + _strAgentFullName + " User: " + User + " ReceiverEmailID: " + ReceiverEmailID + " ContactNo: " + ContactNo + " Remarks: " + Remarks);
                _reocrdsProcessed = _reocrdsProcessed + 1;
                ...
                _AgentRegistrationDAL.MakerRemark = Remarks;
                _AgentRegistrationDAL.UserName = Session["Username"].ToString();
                _dsVerification = _AgentRegistrationDAL.ChangeAgentStatus();
                if (Convert.ToInt32(Convert.ToString(_dsVerification.Tables[0].Rows[0][0])) > 0)
                {
                    _successful = _successful + 1;
                    ErrorLog.AgentManagementTrace("AgLvl1: SingleSave: Successful - Maker Verification.  StatusFlag: " + _StatusFlag + " Flag: " + _Flag + " AgentCode: " + AgentCode + " Fullname: " + _strAgentFullName + " User: " + User + " ReceiverEmailID: " + ReceiverEmailID + " ContactNo: " + ContactNo + " Remarks: " + Remarks);
                    if (ViewState["ActionType"].ToString() == EnumCollection.EnumDBOperationType.Decline.ToString())
                    {
                        #region SMS
                        _EmailSMSAlertscs.FROM = Session["Username"].ToString();
                        ...
                        _EmailSMSAlertscs.HttpGetRequestEmail();
                        #endregion
                        ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showSuccess('Request Declined Successfully', 'Verification Level 1-agent');", true);
                    }
                    else
                    {
                        ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showSuccess('Request Approved Successfully', 'Verification Level 1-agent');", true);
                    }
                }
                else
                {
                    _unsuessful = _unsuessful + 1;
                    ErrorLog.AgentManagementTrace("AgLvl1: SingleSave: Failed - Maker Verification.  StatusFlag: " + _StatusFlag + " Flag: " + _Flag + " AgentCode: " + AgentCode + " Fullname: " + _strAgentFullName + " User: " + User + " ReceiverEmailID: " + ReceiverEmailID + " ContactNo: " + ContactNo + " Remarks: " + Remarks);
                    ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Request Process Unsuccessful', 'Verification Level 1-agent');", true);
                }
            }
            catch (Exception Ex)
            {
                ErrorLog.AgentManagementTrace("AgLvl1: SingleSave: Failed - Maker Verification. Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        #endregion
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: btnSearch_Click: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        ...
        protected void btnClear_Click(object sender, EventArgs e)
        {
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: btnClear_Click: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        #endregion
        ...
        protected void btnApprove_ServerClick(object sender, EventArgs e)
        {
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: btnApprove_ServerClick: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        #endregion
        ...
        protected void btnDecline_ServerClick(object sender, EventArgs e)
        {
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: btnDecline_ServerClick: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        #endregion
        ...
        protected void btnSaveAction_Click(object sender, EventArgs e)
        {
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: btnSaveAction_Click: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
                ViewState["ActionType"] = null;
                ViewState["SelectionType"] = null;
                return;
        ...
        protected void gvAgent_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: gvAgent_PageIndexChanging: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        #endregion
        ...
        protected void chBoxSelectRow_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: chBoxSelectRow_CheckedChanged: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        ...
        protected void CheckBoxAll_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: CheckBoxAll_CheckedChanged: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        ...
        protected void CheckBoxAllOperationOnPageIndex()
        {
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: CheckBoxAllOperationOnPageIndex: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        #endregion
        ...
        protected void EyeImage_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: EyeImage_Click: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        ...
        protected void EyeImage1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: EyeImage1_Click: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        ...
        protected void EyeImage3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: EyeImage3_Click: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        ...
        protected void btnViewDownload_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                if (Ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    string filepath = AppDomain.CurrentDomain.BaseDirectory;
                    ErrorLog.AgentManagementTrace("AgLvl1: btnViewDownload_Click: filepath: " + filepath);
                    //string filepath = HttpContext.Current.Server.MapPath();
                    //string filepath = ConfigurationManager.AppSettings["FilePath"].ToString();
                    strURL = Ds.Tables[0].Rows[0]["IdentityProofDocument"].ToString();
                    string FinalPath = filepath + strURL;
                    ErrorLog.AgentManagementTrace("AgLvl1: btnViewDownload_Click: FinalPath: " + FinalPath);
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: btnViewDownload_Click: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                if (Ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    string filepath = AppDomain.CurrentDomain.BaseDirectory;
                    ErrorLog.AgentManagementTrace("AgLvl1: ImageButton1_Click: filepath: " + filepath);
                    strURL = Ds.Tables[1].Rows[0]["AddressProofDocument"].ToString();
                    string FinalPath = filepath + strURL;
                    ErrorLog.AgentManagementTrace("AgLvl1: ImageButton1_Click: FinalPath: " + FinalPath);
                    string fileName = Path.GetFileName(FinalPath);
                    WebClient req = new WebClient();
                    HttpResponse response = HttpContext.Current.Response;
                    response.Clear();
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: ImageButton1_Click: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        ...
        protected void imgbtnform_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                if (Ds.Tables[2].Rows.Count > 0)
                {
                    ...
                    //string filepath = AppContext.BaseDirectory;
                    string filepath = AppDomain.CurrentDomain.BaseDirectory;
                    ErrorLog.AgentManagementTrace("AgLvl1: imgbtnform_Click: filepath: " + filepath);
                    strURL = Ds.Tables[2].Rows[0]["SignatureProofDocument"].ToString();
                    string FinalPath = filepath + strURL;
                    ErrorLog.AgentManagementTrace("AgLvl1: imgbtnform_Click: FinalPath: " + FinalPath);
                    string fileName = Path.GetFileName(FinalPath);
                    WebClient req = new WebClient();
                    HttpResponse response = HttpContext.Current.Response;
                    response.Clear();
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: imgbtnform_Click: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        #endregion
        ...
        protected void btnSubmitDetails_Click(object sender, EventArgs e)
        {
            if (hdnUserConfirmation.Value.ToString() == "Yes")
            {
                ...
                {
                    ErrorLog.AgentManagementTrace("AgLvl1: btnSubmitDetails_Click: Exception: " + Ex.Message);
                    ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
                }
        ...
        protected void ddlBCCode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: ddlBCCode_SelectedIndexChanged: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        protected void ddlClientCode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: ddlClientCode_SelectedIndexChanged: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        #endregion
        ...
        protected void BtnCsv_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                DataSet dt = FillGrid(EnumCollection.EnumPermissionType.PreExport);
                if (dt != null && dt.Tables[0].Rows.Count > 0)
                {
                    _ExportFormat.ExportInCSV(Convert.ToString(Session["Username"]), "PayRakam", "L1 Approval Agent Details", dt);
                }
                else
                {
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: BtnCsv_Click: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        ...
        protected void BtnXls_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                if (dt != null && dt.Tables[0].Rows.Count > 0)
                {
                    _ExportFormat.ExporttoExcel(Convert.ToString(Session["Username"]), "PayRakam", "L1 Approval Agent Details", dt);
                }
                {
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: BtnXls_Click: Exception: " + Ex.Message);
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
        }
        ...
        private string GenerateToExcel(DataTable Tbl)
        {
            ...
            {
                ErrorLog.AgentManagementTrace("AgLvl1: GenerateToExcel: Exception: " + Ex.Message); 
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
            }
            return "";
        }
        ...
        public DataSet FillGridBulk(EnumCollection.EnumBindingType _EnumBindingType, string sortExpression = null)
        {
            ...
            try
            {
                ...
                _ImportEntity.BCstatus = ((int)EnumCollection.Onboarding.Approve).ToString();
                _ImportEntity.Mstatus = ((int)EnumCollection.Onboarding.MakerPending).ToString();
                gvAgBulkL1.Visible = true;
                ds = _ImportEntity.Get_AgentBulkUpload();
                if (_EnumBindingType == EnumCollection.EnumBindingType.AgBulkL1)
                {
                    if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        {
                            gvAgBulkL1.DataSource = ds.Tables[0];
                            gvAgBulkL1.DataBind();
                            gvAgBulkL1.Visible = true;
        ...
        protected void gvAgBulkL1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName.Contains("DownloadDoc"))
                {
                    ...
                    _ImportEntity.Fileid = Convert.ToInt32(gvAgBulkL1.DataKeys[gvr.RowIndex].Values["FileID"]);
                    ...
                    string dfgfg = Session["BankName"].ToString();
                    string dfgffgfg = Session["Username"].ToString();
                ...
                if (e.CommandName.Contains("DownloadZip"))
                {
                    try
                    {
                        ...
                        GridViewRow gvr = (GridViewRow)lb.NamingContainer;
                        int rowIndex = Convert.ToInt32(e.CommandArgument.ToString());
                        string Fileid = Convert.ToString(gvAgBulkL1.DataKeys[gvr.RowIndex].Values["FileID"]);
        ...
        protected void gvAgBulkL1_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            try
            {
                gvAgBulkL1.PageIndex = e.NewPageIndex;
                if (ViewState["AgentDataSet"] != null)
                {
                    DataTable dsTemp = (DataTable)ViewState["AgentDataSet"];
                    if (dsTemp != null && dsTemp.Rows.Count > 0)
        ...
        private void BindFileId()
        {
            try
            {
                ...
                ddlFileID.DataBind();
                _AgentRegistrationDAL.UserName = Session["Username"].ToString();
                _AgentRegistrationDAL.BCstatus = ((int)EnumCollection.Onboarding.Approve).ToString();
                _AgentRegistrationDAL.Mstatus = ((int)EnumCollection.Onboarding.MakerPending).ToString();
        ...
        protected void BulkApprove_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                _AgentRegistrationDAL.ActionType = "3";
                ...
                {
                    ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showSuccess('Request Approve Successfully', 'Verification Level 1-agent');", true);
                }
                else
                {
                    ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showWarning('Something went wrong. Try again', 'Warning');", true);
        ...
        protected void BulkDecline_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                _AgentRegistrationDAL.UserName = Session["Username"].ToString();
                _AgentRegistrationDAL.MakerRemark = txtResone.Text;
                _AgentRegistrationDAL.ActionType = "4";
                _AgentRegistrationDAL.FileID = Session["FILEID"].ToString();
                _dsVerification = _AgentRegistrationDAL.ChangeAgentStatusBulk();
                if (_dsVerification != null && _dsVerification.Tables[0].Rows.Count > 0)
                {
                    ScriptManager.RegisterStartupScript(this, typeof(Page), "Warning", "showSuccess('Request Decline Successfully', 'Verification Level 1-agent');", true);
