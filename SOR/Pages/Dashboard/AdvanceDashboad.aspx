...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHMasterMain" runat="server">
                            ...
                            <div class="row border-bottom py-2 bg-light">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div id="Agent-daterange" class="input-daterange input-group input-group-sm my-auto ml-auto mr-auto ml-sm-auto mr-sm-0" style="max-width: 350px;">
                                        <input type="text" class="input-sm form-control" name="start" placeholder="Start Date" id="AgentDateRange1">
                                        <input type="text" class="input-sm form-control" name="end" placeholder="End Date" id="AgentDateRange2">
                                        <span class="input-group-append">
                            ...
                            <div class="row border-bottom py-2 bg-light">
                                ...
                                <div class="col-12 col-sm-3">
                                    <div id="Agent" class="input-daterange input-group input-group-sm my-auto ml-auto mr-auto ml-sm-auto mr-sm-0" style="max-width: 350px;">
                                        <input type="text" class="input-sm form-control" name="start" placeholder="Start Date" id="AgentTxnDate1">
                                        <input type="text" class="input-sm form-control" name="end" placeholder="End Date" id="AgentTxnDate2">
                                        <span class="input-group-append">
                            ...
                            <div class="row border-bottom py-2 bg-light">
                                ...
                                <div class="col-12 col-sm-3">
                                    <div id="UniqueCustomer-daterange" class="input-daterange input-group input-group-sm my-auto ml-auto mr-auto ml-sm-auto mr-sm-0" style="max-width: 350px;">
                                        <input type="text" class="input-sm form-control" name="start" placeholder="Start Date" id="UniqueCustomerd1">
                                        <input type="text" class="input-sm form-control" name="end" placeholder="End Date" id="UniqueCustomerd2">
                                        <span class="input-group-append">
    ...
    <input type="hidden" id="hiddenAgentTxnData" value='<%= HttpUtility.JavaScriptStringEncode(ViewState["AgentOnboardingData"]?.ToString() ?? "") %>' />
