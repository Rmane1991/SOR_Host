                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtSwitchName" CssClass="form-control" runat="server" placeholder="Enter Switch Name"></asp:TextBox>
                                    </div>

                                    <div class="form-group">
                                        <label for="SwitchDescription" class="col-form-label">Switch Description</label>
                                        <asp:TextBox ID="txtSwitchDescription" CssClass="form-control" TextMode="MultiLine" Rows="3" runat="server" placeholder="Enter Switch Description"></asp:TextBox>
                                    </div>
