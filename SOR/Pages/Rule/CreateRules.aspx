<%@ Page Title="" Language="C#" MasterPageFile="~/SOR.Master" AutoEventWireup="true" CodeBehind="CreateRules.aspx.cs" Inherits="SOR.Pages.Rule.CreateRules" %>
                    ...
                    <div class="list-group-item">
                        <div class="list-group-item-header">
                            ...
                            <div class="list-view-pf-actions">
                                ...
                                <div>
                                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("group_name") %>'></asp:Label>

                                    <!-- CheckBox Control with OnCheckedChanged event -->
                                    <div class="form-check form-switch">
                                        <asp:CheckBox ID="CheckBox1" runat="server" CssClass="form-check-input"
                                            AutoPostBack="true"
                                            OnCheckedChanged="CheckBox1_CheckedChanged"
                                            Text='<%# Eval("isactive") %>' />
                                        <input class="form-check-input" type="checkbox" role="switch" runat="server"  id="flexSwitchCheckChecked"  checked>
                        ...
                        <asp:Repeater ID="rptRule" runat="server">
                            <ItemTemplate>
                                <div class="list-group-item-container container-fluid hidden" style="background: #ffe8e5; padding: 0px !important; margin: 0px 0px 0px 12px;">
                                    ...
                                    <div class="row" style="box-shadow: 0px 3px 5px 0px gray; margin: 0px 0px 0px 0px;">
                                        <div class="col-md-1">
                                        </div>
                                        <div class="col-md-9">
                                            <div class="list-group-item-header_Next">
                                                <div class="list-view-pf-actions">
                                                    ...
                                                    <div class="dropdown pull-right dropdown-kebab-pf">
                                                        ...
                                                        <%--<asp:Button ID="btnLoadRules" runat="server" CommandName="LoadRules" CommandArgument='<%# Eval("id") %>' Text="Load Rules" />--%>
                                                        <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownKebabRight9">
                                                            <li><a href="#">Action</a></li>
                                                            <li><a href="#">Another Action</a></li>
                                                            <li><a href="#">Something Else Here</a></li>
